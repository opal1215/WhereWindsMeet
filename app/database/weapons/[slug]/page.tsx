...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    const weapon = weaponsDetailData[slug];
    ...
    return {
        ...
        alternates: {
            canonical: `https://wherewindsmeetgame.org/database/weapons/${slug}`,
        },
    };
}
    ...
    return (
        <>
            ...
            <ArticleSchema
                ...
                url={`https://wherewindsmeetgame.org/database/weapons/${slug}`}
            />
            ...
            <BreadcrumbSchema
                items={[
                    ...
                    { name: weapon.name, url: `https://wherewindsmeetgame.org/database/weapons/${slug}` },
                ]}
            />
...
export async function generateStaticParams() {
    return Object.keys(weaponsDetailData).map((slug) => ({
        slug,
    }));
}
